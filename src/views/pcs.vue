...
<template>
  <div id="index">
    ...
    <div v-else class="koi-body">
      ...
      <div class="header">
        <!-- 首页 -->
        <a class="homePage font-bold colorDeepskyblue" :style="{'font-size': Math.round(this.screenWidth/100) + 'px'}"
          href="http://www.baidu.com" target="_self">首页</a>
        <!-- 时间 -->
        <div class="localTime colorPink" :style="{'font-size': Math.round(this.screenWidth/100) + 'px'}">{{ dateYear }}
        ...
        <!-- 标题 -->
        <span class="title font-bold colorLightsteelblue"
          :style="{'font-size': Math.round(this.screenWidth/100) + 'px'}">PCS可视化平台</span>
        <!-- 装饰8 -->
